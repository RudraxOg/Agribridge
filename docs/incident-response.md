...
2. Preserve evidence: retain append-only auth, security, sensitive-access, webhook and settlement events. Do not copy raw credentials, signed URLs or private file contents into tickets.
