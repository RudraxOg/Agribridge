...
import { Boxes, IndianRupee, LayoutDashboard, ShoppingBasket, Sprout, Truck } from "lucide-react";
import { cn } from "@/lib/utils";
import type { NavItem } from "./desktop-sidebar";
const icons = { overview: LayoutDashboard, stock: Boxes, orders: ShoppingBasket, marketplace: Sprout, logistics: Truck, payments: IndianRupee };
